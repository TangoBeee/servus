...
const PluginManifestSchema = z.object({
  ...
  mcpServers: z.record(z.string(), z.object({
    ...
    transport: z.enum(["auto", "stdio", "streamable-http", "sse", "http"]).optional(),
    auth: z.object({
      type: z.enum(["none", "bearer", "header", "oauth", "client_credentials"]).optional(),
  ...
  lspServers: z.record(z.string(), z.object({
    command: z.string(),
    args: z.array(z.string()).optional(),
    env: z.record(z.string(), z.string()).optional(),
