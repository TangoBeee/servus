...
export type BrowserCoreZodSchema = Zod4TypeAny | z3.ZodTypeAny;

export type BrowserCoreZodObject =
  | Zod4Object<Zod4RawShape>
  | z3.ZodObject<z3.ZodRawShape>;

export type InferBrowserCoreSchema<T extends BrowserCoreZodSchema> =
...
export function toJsonSchema(schema: BrowserCoreZodSchema): JsonSchemaDocument {
