// @ts-nocheck
// Pruned dangling import: ../agent/tools/index.js
// Pruned dangling import: ../agent/prompts/agentSystemPrompt.js
...
import { BrowserCoreZodObject } from "../zodCompat.js";
// Pruned dangling import: ../agent/utils/messageProcessing.js
import { LLMClient } from "../llm/LLMClient.js";

// Pruned dangling import: ../types/public/agent.js
import { V3FunctionName } from "../types/public/methods.js";
// Pruned dangling import: ../agent/utils/actionMapping.js
import {
...
// Pruned dangling import: ../agent/utils/handleDoneToolCall.js
...
export class V3AgentHandler {
  ...
  private async prepareAgent(
    ...
    try {
      ...
      if (options.useSearch) {
        const bbApiKey = this.v3.local_providerApiKey;
        if (!bbApiKey) {
      ...
      if (
        ...
        this.logger({
          category: "agent",
          message: `Warning: "${baseModel.modelId}" may not perform well in hybrid mode. See recommended models: https://docs.browser_core.dev/v3/basics/agent#hybrid-mode`,
          level: 0,
        });
      }
  ...
  private createTools(
    ...
    return createAgentTools(this.v3, {
      ...
      toolTimeout,
      useSearch,
      local_providerApiKey: useSearch ? this.v3.local_providerApiKey : undefined,
    });
  }
  ...
  private async ensureDone(
    ...
    messages: ModelMessage[],
    instruction: string,
    outputSchema?: BrowserCoreZodObject,
    logger?: (message: LogLine) => void,
