...
import { BrowserCoreDomProcessError } from "../../../types/public/sdkErrors.js";
 ...
 * decreasing depths. Any non-CBOR failure is surfaced as a BrowserCoreDomProcessError.
 */
    ...
    if (needsExpansion && (nodeId || backendId)) {
      ...
      for (const depth of DESCRIBE_DEPTH_ATTEMPTS) {
        try {
          ...
          throw new BrowserCoreDomProcessError(
