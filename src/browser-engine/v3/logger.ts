...
/**
 * BrowserCore V3 Logging
 *
 * Design goals:
 * - Support concurrent V3 instances with independent logger configuration
 * - Each V3 instance has its own BrowserCoreLogger (handles usePino, verbose, externalLogger)
 ...
 *
 * How it works:
 * - Each V3 instance creates a BrowserCoreLogger in its constructor (per-instance config)
