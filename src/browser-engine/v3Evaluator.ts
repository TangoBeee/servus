// @ts-nocheck
/**
 * V3Evaluator mirrors Evaluator but operates on a V3 instance instead of BrowserCore.
...
import { BrowserCoreInvalidArgumentError } from "./v3/types/public/sdkErrors.js";
